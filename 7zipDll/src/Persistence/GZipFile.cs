...
namespace Compress
{
    public class GZipFile
    {
        ...
        private static void Compress(object obj)
        {
            ...
            ICSharpCode.SharpZipLib.GZip.GZip.Compress(File.OpenRead(inpath), File.Create(outpath), true);
        ...
        private static void DeCompress(object obj)
        {
            ...
            ICSharpCode.SharpZipLib.GZip.GZip.Decompress(File.OpenRead(inpath), File.Create(outpath), true);
        }
